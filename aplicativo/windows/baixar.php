...
echo '</br><a href="http://www.youtubeinmp3.com/fetch/?video=http://www.youtube.com/watch?v=' . $videoid . '" target="_blank" class="btn btn-default btn-lg" style="text-decoration: none;color: #333;display: inline-block;padding: 6px 12px;border: 1px solid transparent;border-radius: 4px;border-color: rgb(15, 158, 222);">Baixar em MP3 - Normal</a></br>';
echo '</br><a href="http://www.youtubeinmp4.com/redirect.php?video=' . $videoid . '&" target="_blank" class="btn btn-default btn-lg baixar_link" style="text-decoration: none;color: #333;display: inline-block;padding: 6px 12px;border: 1px solid transparent;border-radius: 4px;border-color: rgb(15, 158, 222);">Baixar em MP4 - 360p</a></br>';

for ($i = 0; $i < count($avail_formats); $i++) {
if ($avail_formats[$i]['type'] == "video/mp4"){
if ($avail_formats[$i]['quality'] == "hd720"){ $qualidadevideo = "HD 720p";}else{$qualidadevideo = "360p";}
echo '</br><a  href="' . $avail_formats[$i]['url'] . '&title='.$cleanedtitle.'" download target="_blank" class="btn btn-default btn-lg baixar_link" style="text-decoration: none;color: #333;display: inline-block;padding: 6px 12px;border: 1px solid transparent;border-radius: 4px;border-color: rgb(15, 158, 222);">Baixar em MP4 - '.$qualidadevideo.'</a></br>';
}}
}
}
echo '</div>';
